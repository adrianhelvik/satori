...
describe('SVG', () => {
  ...
  it('should preserve svg marker definitions and marker-end references', async () => {
    const svg = await satori(
      <div
        style={{
          width: '100%',
    ...
    expect(embeddedSVG).toContain('<marker')

    expect(toImage(svg, 140)).toMatchImageSnapshot()
  })

  it('should preserve marker attributes for connector-style arrowheads', async () => {
    const svg = await satori(
      <div
        style={{
          width: '100%',
    ...
    expect(embeddedSVG).toContain('marker-width="7"')
    expect(embeddedSVG).toContain('marker-height="7"')
    expect(embeddedSVG).toContain('marker-units="strokeWidth"')
    expect(embeddedSVG).toContain('marker-start="url(#arrow)"')
  ...
  it('should promote style-based marker props for path, line, and polyline elements', async () => {
    const svg = await satori(
      <div
        style={{
          width: '100%',
  ...
  it('should keep explicit marker attributes over style marker props', async () => {
    const svg = await satori(
      <div
        style={{
          width: '100%',
      ...
      >
        ...
        >
          ...
          <line
            ...
            stroke='#000'
            strokeWidth='4'
            markerStart='url(#arrow-a)'
            markerEnd='url(#arrow-b)'
            style={{
              markerStart: 'url(#arrow-b)',
    ...
    expect(embeddedSVG).toContain('marker-start="url(#arrow-a)"')
    expect(embeddedSVG).toContain('marker-end="url(#arrow-b)"')
    expect(embeddedSVG).not.toContain('marker-start="url(#arrow-b)"')
    expect(embeddedSVG).not.toContain('marker-end="url(#arrow-a)"')
  })

  it('should keep explicit marker attributes over kebab-case style marker props', async () => {
    const svg = await satori(
      <div
        style={{
          width: '100%',
