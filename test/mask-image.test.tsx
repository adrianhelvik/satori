...
describe('Mask-*', () => {
  ...
  it('should support mask-origin: content-box', async () => {
    const svg = await satori(
      <div
        style={{
          width: 100,
  ...
  it('should support mask-mode: luminance for gradients', async () => {
    const svg = await satori(
      <div
        style={{
          width: 100,
  ...
  it('should support mask-mode: alpha for url masks', async () => {
    const svg = await satori(
      <div
        style={{
          width: 60,
  ...
  it('should support mask-composite: subtract', async () => {
    const svg = await satori(
      <div
        style={{
          width: 100,
  ...
  it('should support mask-composite: exclude', async () => {
    const svg = await satori(
      <div
        style={{
          width: 100,
